...
def comenzar_consumidor():
    ...
    import threading
    #import tokenizador.modulos.cliente.infraestructura.consumidores as cliente
...
def create_app(configuracion={}):
    ...
    app.config['TESTING'] = configuracion.get('TESTING')
     ...
     # Inicializa la DB
    from tokenizador.config.db import init_db, database_connection
    ...
    from tokenizador.config.db import db
    ...
    with app.app_context():
     ...
     # Importa Blueprints
    from tokenizador.api import cifrador


    # Registro de Blueprints
    app.register_blueprint(cifrador.bp)
